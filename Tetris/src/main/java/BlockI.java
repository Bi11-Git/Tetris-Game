 ...
 * @author KillB
 */
public class BlockI extends Piece {


    public BlockI() {
        image = new ImageIcon("icons//BlockI.png").getImage();
    ...
    public void setBody() {
        ...
        piece[0][X][3] = pieceCenter[X] + TetrisPanel.UNIT_SIZE + TetrisPanel.UNIT_SIZE;
        piece[0][Y][3] = pieceCenter[Y];
        ...
        piece[1][Y][3] = pieceCenter[Y] + TetrisPanel.UNIT_SIZE + TetrisPanel.UNIT_SIZE;
        ...
        piece[2][X][3] = pieceCenter[X] - TetrisPanel.UNIT_SIZE - TetrisPanel.UNIT_SIZE;
        piece[2][Y][3] = pieceCenter[Y];
        ...
        piece[3][Y][3] = pieceCenter[Y] + TetrisPanel.UNIT_SIZE + TetrisPanel.UNIT_SIZE;
