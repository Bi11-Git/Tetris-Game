 ...
 * @author KillB
 */
public class BlockO extends Piece {


    public BlockO() {

        image = new ImageIcon("icons//BlockO.png").getImage();
    ...
    public void setBody() {
        ...
        piece[1][X][1] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[1][Y][1] = pieceCenter[Y];

        piece[1][X][2] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[1][Y][2] = pieceCenter[Y] - TetrisPanel.UNIT_SIZE;

        piece[1][X][3] = pieceCenter[X];
        ...
        piece[3][X][1] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[3][Y][1] = pieceCenter[Y];

        piece[3][X][2] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[3][Y][2] = pieceCenter[Y] - TetrisPanel.UNIT_SIZE;

        piece[3][X][3] = pieceCenter[X];
