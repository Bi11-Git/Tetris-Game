 ...
 * @author KillB
 */
public class BlockZ extends Piece {


    public BlockZ() {

        image = new ImageIcon("icons//BlockZ.png").getImage();
    ...
    public void setBody() {
        ...
        piece[0][X][2] = pieceCenter[X];
        piece[0][Y][2] = pieceCenter[Y] + TetrisPanel.UNIT_SIZE;

        piece[0][X][3] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        ...
        piece[1][X][2] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[1][Y][2] = pieceCenter[Y];

        piece[1][X][3] = pieceCenter[X] + TetrisPanel.UNIT_SIZE;
        piece[1][Y][3] = pieceCenter[Y] - TetrisPanel.UNIT_SIZE;
        ...
        piece[2][X][2] = pieceCenter[X];
        piece[2][Y][2] = pieceCenter[Y] - TetrisPanel.UNIT_SIZE;

        piece[2][X][3] = pieceCenter[X] - TetrisPanel.UNIT_SIZE;
        ...
        piece[3][X][2] = pieceCenter[X] - TetrisPanel.UNIT_SIZE;
        piece[3][Y][2] = pieceCenter[Y];

        piece[3][X][3] = pieceCenter[X] - TetrisPanel.UNIT_SIZE;
        piece[3][Y][3] = pieceCenter[Y] + TetrisPanel.UNIT_SIZE;
